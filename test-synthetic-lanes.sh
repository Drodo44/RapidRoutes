# test-synthetic-lanes.sh
# Direct test of the synthetic pairs with KMA diversity

echo "Testing synthetic pairs with KMA diversity..."

# Directly add synthetic logic with KMA codes to demonstrate it works
cat > test-synthetic.js << 'EOF'
