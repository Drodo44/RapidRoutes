        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 shadow-lg overflow-hidden mb-8">
          <div className="flex items-center justify-between p-4 bg-gray-800 border-b border-gray-700">
            ...
            <div className="flex gap-2">
              <button onClick={() => bulkExport({ fill:true })} className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition">Export DAT Template</button>
            </div>
          </div>
