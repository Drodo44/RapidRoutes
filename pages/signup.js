      ...
      <div className="card">
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          <input type="text" placeholder="Full Name" value={name} onChange={(e) => setName(e.target.value)}
            required className="w-full p-3 rounded-lg bg-gray-800 border border-gray-600 text-white" />
          ...
          <a href="/login" className="text-cyan-400 hover:underline">Already have an account? Login</a>
        </form>
      </div>
    </div>
  );
