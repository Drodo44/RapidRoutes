...
async function localCityLookup(city, state) {
  // Disabled to prevent "node:fs/promises" build errors in client bundle
  // This was a fallback for offline/local development with JSON files
  // TODO: Restoration requires moving this to a server-only API route
  return null;
}
