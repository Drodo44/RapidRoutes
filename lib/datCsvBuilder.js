...
function baseRowFrom(lane, origin, dest, contact, usedRefIds = new Set(), generatedRefIds = new Map()) {
  ...
  return {
    'Pickup Earliest*': String(lane.pickup_earliest), // Required: Full ISO 8601 datetime string YYYY-MM-DDTHH:mm:ss.sssZ
    'Pickup Latest': String(pickupLatest), // Required: Full ISO 8601 datetime string YYYY-MM-DDTHH:mm:ss.sssZ - defaults to earliest if missing
