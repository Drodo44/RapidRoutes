...
function baseRowFrom(lane, origin, dest, contact, usedRefIds = new Set(), generatedRefIds = new Map()) {
  ...
  return {
    'Pickup Earliest*': lane.pickup_earliest, // Required: Full ISO 8601 datetime YYYY-MM-DDTHH:mm:ss.sssZ
    'Pickup Latest': pickupLatest, // Required: Full ISO 8601 datetime YYYY-MM-DDTHH:mm:ss.sssZ - defaults to earliest if missing
