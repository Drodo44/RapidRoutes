...
function baseRowFrom(lane, origin, dest, contact, usedRefIds = new Set()) {
  ...
  return {
    ...
    'DAT Load Board Rate': '', // Column H: COMPLETELY BLANK - DAT requirement  
    'Allow DAT Load Board Booking': '', // Column I: BLANK - DAT requirement
    ...
    'Reference ID (unique per organization; max 8 chars)': `="` + uniqueRefId.slice(0, 8) + `"` // TEXT FORMAT - Forces Excel to preserve text (displays as RR12345)
  };
}
