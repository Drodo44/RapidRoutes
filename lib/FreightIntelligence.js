...
export class FreightIntelligence {
  ...
  async addMajorFloridaCities(originState, destinationState) {
    ...
    const majorFLCities = [
      'Jacksonville', 'Orlando', 'Tampa', 'Miami', 'Fort Lauderdale',
      'West Palm Beach', 'Ocala', 'Lakeland', 'Gainesville', 'Tallahassee',
      'Fort Myers', 'Port St. Lucie', 'Cape Coral', 'Daytona Beach'
    ];
