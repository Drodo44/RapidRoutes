...
export const EQUIPMENT_SEED = [
  ...
  { code: 'HO',  label: 'Hopper Open' },
  { code: 'NU',  label: 'Pneumatic' },
  { code: 'WF',  label: 'Walking Floor / Live Bottom' },
  { code: 'LA',  label: 'Drop Deck Landoll' },
  { code: 'AC',  label: 'Auto Carrier' },
  { code: 'A2',  label: 'Auto Carrier Double' },
  { code: 'BT',  label: 'B-Train' },
  { code: 'MV',  label: 'Moving Van' },
  { code: 'MA',  label: 'Moving Van Air-Ride' },
  { code: 'SV',  label: 'Sprinter Van' },
  { code: 'SC',  label: 'Sprinter Van Temp-Controlled' },
  { code: 'SZ',  label: 'Sprinter Van HazMat' },
  { code: 'SM',  label: 'Sprinter Van w/Team' },

  // Tankers
  { code: 'TN',  label: 'Tanker (Non-food)' },
  { code: 'TF',  label: 'Tanker (Food Grade)' },
  { code: 'TA',  label: 'Tanker Aluminum' },
  { code: 'TS',  label: 'Tanker Steel' },
  { code: 'TI',  label: 'Tanker Intermodal' },
  { code: 'PN',  label: 'Pneumatic Tank' },
  { code: 'TT',  label: 'Truck and Trailer' },

  // Power only / straight / hotshot
  { code: 'PO',  label: 'Power Only' },
  { code: 'ST',  label: 'Straight Truck' },
  { code: 'SB',  label: 'Straight Box Truck' },
  { code: 'BR',  label: 'Straight Box Truck Reefer' },
  { code: 'BZ',  label: 'Straight Box Truck HazMat' },
