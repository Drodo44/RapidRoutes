...
export async function generateGeographicCrawlPairs(origin, dest, radiusMiles = 75) {
  ...
  // Validate minimum KMA requirements
  if (seenPairs.size < 5) {
    console.warn(`⚠️ GEOCRAWL WARNING: Generated only ${seenPairs.size} unique KMAs, minimum recommended is 5`, {
