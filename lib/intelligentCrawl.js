  ...
  try {
    ...
    if (preferredPickups.length > 0) {
      ...
      if (matchingPickup) {
        ...
        // This is one of your preferred pickups - use enhanced geographic crawl
    ...
    // FALLBACK: Use enhanced geographic crawl for all non-preferred origins
    console.log(`🗺️ Using enhanced geographic crawl with intelligent fallbacks`);
    const result = await generateGeographicCrawlPairs({
      origin,
      destination,
      equipment,
