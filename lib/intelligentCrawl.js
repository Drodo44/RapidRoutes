  ...
  try {
    ...
    if (preferredPickups.length > 0) {
      ...
      if (matchingPickup) {
        ...
        // This is one of your preferred pickups - use learning intelligent system
        console.log(`🧠 LEARNING MODE: Discovering new cities while generating intelligent pairs`);
    ...
    // FALLBACK: Use learning intelligent system for all non-preferred origins
    console.log(`🧠 LEARNING INTELLIGENT SYSTEM: Expanding database while generating pairs`);
    const result = await generateLearningIntelligentPairs({
      origin,
      destination,
      equipment,
