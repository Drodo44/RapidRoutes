...
export async function generateAlternativeCitiesWithHERE(centerLat, centerLng, radiusMiles = 75, limit = 20) {
  ...
  try {
    ...
    // Use discover API with circle area constraint - search for places instead of generic "city"
    const url = `https://discover.search.hereapi.com/v1/discover?q=*&in=circle:${centerLat},${centerLng};r=${radiusMeters}&limit=${limit}&apiKey=${HERE_API_KEY}`;
