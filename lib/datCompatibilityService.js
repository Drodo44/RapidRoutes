 ...
 */
export async function getDatCompatibleCitiesWithinRadius(baseCity, radiusMiles = 150, limit = 50) {
  try {
    console.log(`🔍 Finding DAT-compatible cities within ${radiusMiles} miles of ${baseCity.city}, ${baseCity.state}`);
