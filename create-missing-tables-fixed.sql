...
-- FIXED VERSION - Corrects UUID/text type mismatch
...
-- Create RLS policies for user_prefs (FIXED: proper UUID casting)
...
-- Create RLS policies for preferred_pickups (FIXED: proper UUID casting)
